...
# ============================
header = make_header_with_logo("MiSafe Logged Details From 01st March to 19th Nov 2025")
story.append(header)
...
chart_header_2a = make_header_with_logo("Dashboard – Division Specific")
...
story.append(PageBreak())
chart_header_2b = make_header_with_logo("Dashboard – Division Specific")
...
# ============================
story.append(PageBreak())
chart_header_3 = make_header_with_logo("Summary Dashboard")
